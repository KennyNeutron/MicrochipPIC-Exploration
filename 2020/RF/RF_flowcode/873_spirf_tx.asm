...
CompTempVar2223                  EQU	0x00000048 ; bytes:1
CompTempVar2225                  EQU	0x00000048 ; bytes:1
CompTempVar2230                  EQU	0x00000048 ; bytes:1
CompTempVar2231                  EQU	0x00000048 ; bytes:1
FC_CAL_SPI_00064_arg_DataOut     EQU	0x00000049 ; bytes:1
CompTempVarRet2232               EQU	0x0000004B ; bytes:1
FC_CAL_SPI_00064_1_retVal        EQU	0x0000004A ; bytes:1
FCD_SPI_Le_00052_arg_Char        EQU	0x00000048 ; bytes:1
FCD_SPI_Le_00054_1_retVal        EQU	0x00000048 ; bytes:1
FCD_LCDDis_00070_arg_in          EQU	0x00000052 ; bytes:1
FCD_LCDDis_00070_arg_mask        EQU	0x00000053 ; bytes:1
FCD_LCDDis_00070_1_pt            EQU	0x00000054 ; bytes:1
...
CompTempVar2249                  EQU	0x00000048 ; bytes:1
...
; { FCD_LCDDisplay0_RawSend ; function begin
	...
	BCF gbl_portb,0
	BCF gbl_portb,1
	SWAPF FCD_LCDDis_00070_arg_in, W
	ANDLW 0x0F
	MOVWF FCD_LCDDis_00070_1_pt
	MOVLW 0x0F
	ANDWF FCD_LCDDis_00070_1_pt, F
	BTFSC FCD_LCDDis_00070_1_pt,0
	BSF gbl_portb,2
	BTFSC FCD_LCDDis_00070_1_pt,1
	BSF gbl_portb,3
	BTFSC FCD_LCDDis_00070_1_pt,2
	BSF gbl_portb,4
	BTFSC FCD_LCDDis_00070_1_pt,3
	BSF gbl_portb,5
	MOVF FCD_LCDDis_00070_arg_mask, F
	BTFSS STATUS,Z
	BSF gbl_portb,0
	MOVLW 0x0A
	...
	BCF gbl_portb,1
	MOVLW 0x0F
	ANDWF FCD_LCDDis_00070_arg_in, W
	MOVWF FCD_LCDDis_00070_1_pt
	MOVLW 0x0A
	MOVWF delay_10us_00000_arg_del
	CALL delay_10us_00000
...
; { FC_CAL_SPI_Master_Byte_1 ; function begin
	CLRF FC_CAL_SPI_00064_1_retVal
	MOVF FC_CAL_SPI_00064_arg_DataOut, W
	MOVWF gbl_sspbuf
label9
	BSF STATUS, RP0
	BTFSS gbl_sspstat,0
	...
	BCF STATUS, RP0
	MOVF gbl_sspbuf, W
	MOVWF FC_CAL_SPI_00064_1_retVal
	MOVF FC_CAL_SPI_00064_1_retVal, W
...
label13
	...
	MOVWF FCD_LCDDis_00070_arg_in
	CLRF FCD_LCDDis_00070_arg_mask
...
; { FCD_SPI_Legacy0_SPI_Get_Char ; function begin
	...
	MOVLW 0xFF
	MOVWF FC_CAL_SPI_00064_arg_DataOut
...
; { FCD_LCDDisplay0_PrintNumber ; function begin
	...
	MOVWF FCD_LCDDis_00070_arg_in
	MOVLW 0x10
	MOVWF FCD_LCDDis_00070_arg_mask
	CALL FCD_LCDDis_00070
...
; } FCD_LCDDisplay0_ClearLine function end
	...
	ORG 0x00000222
FCM_radio__00061
; { FCM_radio_transmit ; function begin
	MOVLW 0xFB
	BSF STATUS, RP0
	BCF STATUS, RP1
	ANDWF gbl_trisc, W
	...
	MOVWF gbl_portc
	RETURN
; } FCM_radio_transmit function end

	ORG 0x00000257
FCM_radio__0005C
; { FCM_radio_setwriting_address ; function begin
	MOVLW 0xFB
	BSF STATUS, RP0
	BCF STATUS, RP1
	ANDWF gbl_trisc, W
	...
	MOVWF gbl_portc
	RETURN
; } FCM_radio_setwriting_address function end

	ORG 0x000002A8
FCM_radio__0005A
; { FCM_radio_writedata ; function begin
	MOVLW 0xFB
	BSF STATUS, RP0
	BCF STATUS, RP1
	ANDWF gbl_trisc, W
	...
	MOVWF gbl_portc
	RETURN
; } FCM_radio_writedata function end
...
; { main ; function begin
	...
	MOVWF gbl_FCV_SPI_MOSI
	MOVWF gbl_FCV_SPI_MISO
	CALL FCD_LCDDis_00071
	CALL FCD_LCDDis_00072
	MOVLW 0xFD
	BSF STATUS, RP0
	ANDWF gbl_trisc, W
	MOVWF gbl_trisc
...
label40
	...
	CALL delay_ms_00000
label41
	CALL FCM_radio__0005A
	CALL FCM_radio__00061
