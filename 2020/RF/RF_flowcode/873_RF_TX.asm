...
FCD_LCDDis_00059_arg_in          EQU	0x0000004B ; bytes:1
FCD_LCDDis_00059_arg_mask        EQU	0x0000004C ; bytes:1
FCD_LCDDis_00059_1_pt            EQU	0x0000004D ; bytes:1
...
; } FCM_radio_writepayload function end
	...
	ORG 0x0000025D
FCM_open_w_00055
; { FCM_open_writing_pipe_address ; function begin
	MOVLW 0x30
	BCF STATUS, RP0
	BCF STATUS, RP1
	MOVWF gbl_FCV_OSPI_DATAOUT
	...
	CALL FCM_own_sp_00051
	RETURN
; } FCM_open_writing_pipe_address function end
...
label37
	...
	CALL FCM_open_w_00055
	CALL FCM_rf_set_00054
	CALL FCM_activa_00058
