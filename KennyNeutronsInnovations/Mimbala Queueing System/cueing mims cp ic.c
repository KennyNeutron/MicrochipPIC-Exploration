//************************************************************************************
//**  
//**  File name:     C:\Users\Acer-PC\Desktop\mimbala cueing\cueing mims cp ic.c
//**  Title:         
//**  Description:   
//**  
//**  Generated by:  Flowcode v5.2.0.0
//**  Date:          Sunday, December 02, 2018 19:28:05
	...
	while (1)
	{
		...
		switch (FCV_SWITCH)
		{
			case 1:
			{
				...
				//Call Component Macro: SendRS232String("A")
				FCD_RS2320_SendRS232String("A", 1);
			...
			{
				//Call Component Macro
				//Call Component Macro: SendRS232Char("B")
				FCD_RS2320_SendRS232Char('B');
			...
			{
				//Call Component Macro
				//Call Component Macro: SendRS232Char("C")
				FCD_RS2320_SendRS232Char('C');
			...
			{
				//Call Component Macro
				//Call Component Macro: SendRS232Char("D")
				FCD_RS2320_SendRS232Char('D');
			...
			{
				//Call Component Macro
				//Call Component Macro: SendRS232Char("E")
			...
			{
				//Call Component Macro
				//Call Component Macro: SendRS232Char("F")
			...
			{
				//Call Component Macro
				//Call Component Macro: SendRS232Char("Z")
				FCD_RS2320_SendRS232Char('Z');
