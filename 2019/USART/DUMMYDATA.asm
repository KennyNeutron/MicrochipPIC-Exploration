...
FCD_RS2320_00048_arg_nChar       EQU	0x00000061 ; bytes:2
FCD_RS2320_00049_arg_String      EQU	0x00000042 ; bytes:2
FCD_RS2320_00049_arg_MSZ_String  EQU	0x0000005F ; bytes:1
FCD_RS2320_00049_1_idx           EQU	0x00000060 ; bytes:1
CompTempVar2217                  EQU	0x00000044 ; bytes:27
...
label3
	...
	BTFSS gbl_pir1,4
	GOTO	label3
	MOVF FCD_RS2320_00048_arg_nChar, W
	MOVWF gbl_txreg
	RETURN
...
; { FCD_RS2320_SendRS232String ; function begin
	CLRF FCD_RS2320_00049_1_idx
label4
	MOVF FCD_RS2320_00049_arg_MSZ_String, W
	SUBWF FCD_RS2320_00049_1_idx, W
	BTFSC STATUS,C
	RETURN
	BCF STATUS,IRP
	BTFSC FCD_RS2320_00049_arg_String+D'1',0
	BSF STATUS,IRP
	MOVF FCD_RS2320_00049_arg_String, W
	ADDWF FCD_RS2320_00049_1_idx, W
	MOVWF FSR
	MOVF INDF, F
	BTFSC STATUS,Z
	RETURN
	...
	MOVWF FSR
	MOVF INDF, W
	MOVWF FCD_RS2320_00048_arg_nChar
	CLRF FCD_RS2320_00048_arg_nChar+D'1'
	CALL FCD_RS2320_00048
	INCF FCD_RS2320_00049_1_idx, F
	GOTO	label4
...
label5
	...
	MOVWF CompTempVar2217+D'12'
	MOVLW 0x31
	MOVWF CompTempVar2217+D'6'
	MOVWF CompTempVar2217+D'14'
	MOVWF CompTempVar2217+D'17'
	MOVWF CompTempVar2217+D'23'
	MOVLW 0x32
	MOVWF CompTempVar2217+D'4'
	MOVWF CompTempVar2217+D'15'
	MOVWF CompTempVar2217+D'20'
	MOVWF CompTempVar2217+D'22'
	MOVLW 0x33
	MOVWF CompTempVar2217+D'5'
	MOVWF CompTempVar2217+D'9'
	MOVWF CompTempVar2217+D'16'
	MOVWF CompTempVar2217+D'18'
	MOVWF CompTempVar2217+D'21'
	MOVLW 0x34
	MOVWF CompTempVar2217+D'19'
	MOVLW 0x35
	MOVWF CompTempVar2217+D'2'
	MOVWF CompTempVar2217+D'3'
	MOVWF CompTempVar2217+D'13'
	MOVLW 0x36
	MOVWF CompTempVar2217+D'10'
	MOVLW 0x37
	MOVWF CompTempVar2217+D'11'
	MOVLW 0x39
	MOVWF CompTempVar2217+D'8'
	MOVLW 0x41
	MOVWF CompTempVar2217
	MOVWF CompTempVar2217+D'1'
	MOVWF CompTempVar2217+D'24'
	MOVLW 0x42
	MOVWF CompTempVar2217+D'25'
	CLRF CompTempVar2217+D'26'
	MOVLW HIGH(CompTempVar2217+D'0')
	MOVWF FCD_RS2320_00049_arg_String+D'1'
	MOVLW LOW(CompTempVar2217+D'0')
	MOVWF FCD_RS2320_00049_arg_String
	MOVLW 0x1A
	MOVWF FCD_RS2320_00049_arg_MSZ_String
