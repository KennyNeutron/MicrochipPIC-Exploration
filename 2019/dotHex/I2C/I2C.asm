...
; Heap block 1, size:40 (0x00000057 - 0x0000007E)
__HEAP_BLOCK1_BANK               EQU	0x00000000
__HEAP_BLOCK1_START_OFFSET       EQU	0x00000057
...
gbl_FCV_RETURN                   EQU	0x00000042 ; bytes:1
Wdt_Delay__0003E_arg_delay       EQU	0x00000045 ; bytes:1
Wdt_Delay__0003E_1_i             EQU	0x00000046 ; bytes:1
FCD_LCDDis_00056_arg_in          EQU	0x00000053 ; bytes:1
FCD_LCDDis_00056_arg_mask        EQU	0x00000054 ; bytes:1
FCD_LCDDis_00056_1_pt            EQU	0x00000055 ; bytes:1
FCD_LCDDis_0005B_arg_x           EQU	0x00000043 ; bytes:1
FCD_LCDDis_0005B_arg_y           EQU	0x00000044 ; bytes:1
FCD_LCDDis_0005D_arg_String      EQU	0x00000043 ; bytes:2
FCD_LCDDis_0005D_arg_MSZ_String  EQU	0x00000051 ; bytes:1
FCD_LCDDis_0005D_1_idx           EQU	0x00000052 ; bytes:1
CompTempVar2237                  EQU	0x00000045 ; bytes:12
...
; { FCD_LCDDisplay0_PrintString ; function begin
	CLRF FCD_LCDDis_0005D_1_idx
	CLRF FCD_LCDDis_0005D_1_idx
label5
	MOVF FCD_LCDDis_0005D_arg_MSZ_String, W
	SUBWF FCD_LCDDis_0005D_1_idx, W
	BTFSC STATUS,C
	RETURN
	BCF STATUS,IRP
	BTFSC FCD_LCDDis_0005D_arg_String+D'1',0
	BSF STATUS,IRP
	MOVF FCD_LCDDis_0005D_arg_String, W
	ADDWF FCD_LCDDis_0005D_1_idx, W
	MOVWF FSR
	MOVF INDF, F
	BTFSC STATUS,Z
	RETURN
...
; { FCD_LCDDisplay0_Cursor ; function begin
	MOVF FCD_LCDDis_0005B_arg_y, F
	BTFSS STATUS,Z
	GOTO	label6
	MOVLW 0x80
	MOVWF FCD_LCDDis_0005B_arg_y
	GOTO	label9
label6
	DECF FCD_LCDDis_0005B_arg_y, W
	BTFSS STATUS,Z
	GOTO	label7
	MOVLW 0xC0
	MOVWF FCD_LCDDis_0005B_arg_y
...
label8
	...
	MOVWF FCD_LCDDis_0005B_arg_y
label9
	MOVF FCD_LCDDis_0005B_arg_x, W
	ADDWF FCD_LCDDis_0005B_arg_y, W
	MOVWF FCD_LCDDis_00056_arg_in
...
; { main ; function begin
	...
	CALL FCD_I2C_Ma_00069
	CALL FCD_LCDDis_00057
	CALL FCD_LCDDis_00058
label10
	CLRF FCD_LCDDis_0005B_arg_x
	CLRF FCD_LCDDis_0005B_arg_y
	...
	CLRF CompTempVar2237+D'11'
	MOVLW HIGH(CompTempVar2237+D'0')
	MOVWF FCD_LCDDis_0005D_arg_String+D'1'
	MOVLW LOW(CompTempVar2237+D'0')
	MOVWF FCD_LCDDis_0005D_arg_String
	MOVLW 0x0B
	MOVWF FCD_LCDDis_0005D_arg_MSZ_String
